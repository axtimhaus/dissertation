...
def with_node_count(model: Input, n):
...
STUDIES = [
    RemeshingStudy(
        ...
        input=BASE_INPUT,
        display_tex="No Surface Remeshing",
    ),
    # RemeshingStudy(
    #     name="no_surface_remeshing_200",
    #     input=with_node_count(BASE_INPUT, 200),
    #     display_tex="No Surface Remeshing 200",
    # ),
    # RemeshingStudy(
    #     name="no_surface_remeshing_500",
    #     input=with_node_count(BASE_INPUT, 500),
    #     display_tex="No Surface Remeshing 500",
    # ),
    # RemeshingStudy(
