...
\begin{enumerate}
    ...
    \item Transfer between particles was neglected, which disallowed the occurrence of grain growth in the parameter studies of asymmetric geometry (\cref{subsec:parameter-study-particle-size-ratio,subsec:parameter-study-ovality}),
