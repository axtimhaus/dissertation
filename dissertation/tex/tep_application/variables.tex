...
The internal state variables are the polar coordinates of the nodes $\left[ \Radius, \Angle \right]$ with the pole in their particle's center, since they determine the thermodynamic forces and the main aim of the simulation is to follow the time evolution of the particles and nodes.
The coordinates of the particles $\left[ \X_{\Particle}, \Y_{\Particle} \right]$ are internal degrees of freedom, since they are unambiguously defined, if the coordinates of all nodes relative to their particle are known and also which nodes are in contact to each other.
Also, they have no inherent driving force in case of pressureless sintering, for the case of pressure assisted sintering, the pressure potential can be applied as their driving force (not covered in this work).
