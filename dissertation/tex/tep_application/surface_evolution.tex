...
A $\SurfaceVectorAngle_{\Normal} = \qty{90}{\degree}$ means an even surface, thus energy loss in both shifting directions.

The partial derivative of Gibbs energy is obtained by finding the limit at ${\Step\Shift}_{\Normal} = 0$ as in \autoref{eq:gibbs-partial-surface-normal}.
...
The volume derivative, however, is obtained by calculating the area of the triangles formed by $\SurfaceDistance$, $\SurfaceDistance'$ and $\Step\Shift_{\Normal}$ to the upper and lower.
...
Counting both contributions positively and finding the limit at ${\Step\Shift}_{\Normal} = 0$ as before leads to the partial derivative in \autoref{eq:volume-partial-surface-normal}.
...
The change in Gibbs energy is calculated similarly acc.~to~\autoref{eq:gibbs-diff-surface-tangential}, but the shifted surface lengths calculate as in \autoref{eq:surface-distance-shifted-tangential} in dependence on the tangential shift ${\Step\Shift}_{\Tangential}$.
...
Again, the partial derivative of Gibbs energy is found by the limit at ${\Step\Shift}_{\Tangential} = 0$.
...
The partial derivative of volume is found equivalently, but the contribution of the lower side is here counted negatively.
