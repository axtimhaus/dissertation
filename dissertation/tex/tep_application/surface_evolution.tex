...
With a certain normal shift ${\Step\Shift}_\Normal$, the surface lengths after shifting are calculated by \cref{eq:surface-distance-shifted-normal}.
\begin{subequations}
    \begin{align}
...
The change in Gibbs energy is calculated similarly as in the normal case according to \cref{eq:gibbs-diff-surface-tangential}, but the shifted surface lengths are calculated as in \cref{eq:surface-distance-shifted-tangential} in dependence on the tangential shift ${\Step\Shift}_{\Tangential}$.
