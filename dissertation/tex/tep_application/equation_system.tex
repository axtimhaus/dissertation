...
\subsection{Dissipation \texorpdfstring{$\Dissipation$}{D}}
...
\subsection{Dissipation Function \texorpdfstring{$\DissipationFunction$}{Q}}
...
\subsection{Constraints \texorpdfstring{$\Vect\Constraint$}{g}}
...
This is done by constraints setting its displacement to zero as in the \cref{eq:fixed-particle-constraints}.
\begin{subequations}
...
This is equivalent to that the node must have the identical position in global space when viewed from either of the involved particles, as already noted in \cref{sec:particle-representation}.
