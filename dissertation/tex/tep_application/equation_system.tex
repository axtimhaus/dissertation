...
This is equivalent to that the node must have the identical position in global space when viewn from either of the involved particles, as already noted in \autoref{sec:particle-representation}.
