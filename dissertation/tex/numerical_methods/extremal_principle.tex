...
\todo{Brief introduction to non-equilibrium and internal state variables}
...
These are required to be able to solve the problem, as the dissipation function $\DissipationFunction$ includes non-linear forms of the fluxes $\Vect\Flux$ and so the fluxes are feasible targets to optimization.
...
Internal degrees of freedom will be collected in $\Vect\InternalDegreeOfFreedom$ to incoporate their dissipative contributions.
