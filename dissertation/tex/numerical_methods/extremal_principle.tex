...
The problem is reformulated as the Lagrange functional $\LagrangeFunction$ in \cref{eq:tep-classic-lagrange} with the additional parameter $\LagrangeParameter$.
\begin{equation}
