\section{The Thermodynamic Extremal Principle}\label{sec:extremal-priciple}
...
Note that the velocities $\Vect{\InternalStateVelocity}$ are \emph{not} required to be identical to the fluxes $\Vect\Flux$ here, neither must they have the same size.
...
$\Vect\RequiredConstraint$ and $\Vect\InternalStateVelocity$ must be of the same size.
But it is also possible to include several \emph{additional} constraints $\Vect\AdditionalConstraint$.
...
\begin{subequations}
    \begin{align}
        ...
        \Vect\AdditionalConstraint(\Vect\ExternalStateVariable, \Vect\InternalStateVariable, \Vect{\InternalStateVelocity}, \Vect\Flux, \Vect\AuxiliaryVariable) &= 0 \label{eq:additonal-constraints}
    \end{align}
\end{subequations}
...
The vector parameters $\Vect{\LagrangeParameter_2}$ and $\Vect{\LagrangeParameter_3}$ for the required and additional constraints are of the same size as $\Vect\RequiredConstraint$ resp. $\Vect\AdditionalConstraint$.
...
\begin{equation}
    ...
    + \Transposed{\Vect\AdditionalConstraint}(\Vect\ExternalStateVariable, \Vect\InternalStateVariable, \Vect{\InternalStateVelocity}, \Vect\Flux, \Vect\AuxiliaryVariable) \cdot \Vect{\LagrangeParameter_3}
...
\begin{subequations}
    \begin{align}
        ...
        + \frac{\partial\Transposed{\Vect\AdditionalConstraint}(\Vect\ExternalStateVariable, \Vect\InternalStateVariable, \Vect{\InternalStateVelocity}, \Vect\Flux, \Vect\AuxiliaryVariable)}{\partial \Vect{\InternalStateVelocity}} \cdot \Vect{\LagrangeParameter_3}
        &&\stackrel{!}{=} 0 \\
        %
        ...
        + \frac{\partial\Transposed{\Vect\AdditionalConstraint}(\Vect\ExternalStateVariable, \Vect\InternalStateVariable, \Vect{\InternalStateVelocity}, \Vect\Flux, \Vect\AuxiliaryVariable)}{\partial \Vect{\Flux}} \cdot \Vect{\LagrangeParameter_3}
        &&\stackrel{!}{=} 0 \\
        %
        ...
        + \frac{\partial\Transposed{\Vect\AdditionalConstraint}(\Vect\ExternalStateVariable, \Vect\InternalStateVariable, \Vect{\InternalStateVelocity}, \Vect\Flux, \Vect\AuxiliaryVariable)}{\partial \Vect{\AuxiliaryVariable}} \cdot \Vect{\LagrangeParameter_3}
        &&\stackrel{!}{=} 0 \\
        %
        ...
        %
        &\LagrangeFunction_{\Vect\LagrangeParameter_3} &&= \Vect\AdditionalConstraint(\Vect\ExternalStateVariable, \Vect\InternalStateVariable, \Vect{\InternalStateVelocity}, \Vect\Flux, \Vect\AuxiliaryVariable) &&\stackrel{!}{=} 0
    \end{align}
\end{subequations}
