...
The dissipation $\Dissipation$ can be formulated as in \cref{eq:dissipation} in dependence on the vector of \gls{EVS} $\Vect\ExternalStateVariable$, the vector of \gls{IVS} $\Vect\InternalStateVariable$ and the velocity vector of \gls{IVS} $\Vect{\InternalStateVelocity}$, see \cref{subsec:internal-variables-of-state} for a brief introduction on \gls{IVS}.
