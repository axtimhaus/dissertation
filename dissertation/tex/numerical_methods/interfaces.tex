...
For sintering, these governing equations are usually randomized, which leads to the \glsfirst{kMCM}, which will be discussed in \autoref{subsubsec:monte-carlo-kinetic-sintering}.
