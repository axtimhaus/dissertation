...
The time evolution of the auxiliary function is described with the interface velocity vector $\Vect v$ by
\begin{equation}
...
The curvature is obtained from the gradient of the level-set function by
\begin{equation}
    \Curvature = \nabla \cdot \frac{\nabla\phi}{\Abs{\nabla\phi}}
...
The width of the interface can be estimated using
\begin{equation}
...
For conserved order parameters, the Cahn-Hillard equation \cite{Cahn1961} can be applied instead as
\begin{equation}
