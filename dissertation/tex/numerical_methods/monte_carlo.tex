...
Both will be discuseed in \autoref{subsec:monte-carlo-classic}.
A method of this type will be applied for powder modelling in \autoref{sec:statistical-powder-modeling}.
...
The basic idea behind most kinetic \glspl{MCM} (f.e. \cite{Braginsky2005, Luque2010, Tikare2003, Wang2018, Bjork2012}) is to discretize the model space into finite volumes (voxels) with a defined discrete state, which may change with a defined probability.
...
\citeauthor{Tikare2003}\cite{Braginsky2005, Tikare2003, Bjork2012, Tikare2010} evaluate the energy change $\Diff E$ of the system for the case the state change has actually happened.
...
In contrast, a high count of solids beneath a non-solid one mean a high concave curvature.
