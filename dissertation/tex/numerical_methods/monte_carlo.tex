...
Both will be discussed in \autoref{subsec:monte-carlo-classic}.
A method of this type will be applied for powder modeling in \autoref{sec:statistical-powder-modeling}.
...
These methods will be briefly discussed in \autoref{subsec:monte-carlo-kinetic-sintering}.
...
The energy change is then correlated to the probability by \autoref{eq:kinetic-monte-carlo-energy-probability}, where a negative energy change (reduction of system energy) is always accepted, however positive ones tend to zero probability by an exponential law.
\begin{equation}
    \Probability =
    \begin{cases}
