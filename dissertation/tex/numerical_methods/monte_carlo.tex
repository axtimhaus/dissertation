...
The basic idea behind classic \glspl{MCM} is to use randomly sampled values as input to a function and analyzing the distribution of result values afterwards using the methods of descriptive statistics.
...
Let us consider a function $f$ which is deterministic, but is fed with a stochastic variable $X$ and maps this to another stochastic variable $Y$ as shown in \cref{eq:monte-carlo-function}.
\begin{equation}
    Y = f(X)
