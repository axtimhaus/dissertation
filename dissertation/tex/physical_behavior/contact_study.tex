...
As previously observed in \autoref{subsubsec:parameter-study-asymmetric-surface-diffusion-ratio}, the grain boundaries between inert and active particles are curved, sicne the active particle creeps around the inert one.
