...
\textcite{Jing2003} reported \gls{PFM} simulations of a single pore which first show the deviation to the upper side, also observed here, and than the transition into steady state when the pore was fully closed.
