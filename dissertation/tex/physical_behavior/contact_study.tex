...
As previously observed in \autoref{subsec:parameter-study-asymmetric-surface-diffusion-ratio}, the grain boundaries between inert and active particles are curved, since the active particle creeps around the inert one.
