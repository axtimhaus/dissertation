...
The beginning of pore closing is first noticed by an deviation to the lower from the straight line.
...
The numerical behavior of all cases with an inert is remarkably worse than of the pure active cases, as is apparent from the kinks in the result curves.
The detailed logs of the simulation suggest the reason to lie in the neck remeshing being more erratic on the inert particle.
