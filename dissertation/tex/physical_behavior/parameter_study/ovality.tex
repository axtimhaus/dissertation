...
Oval particles have two additional degrees of freedom regarding the initial contact by rotation, here three distinct cases will be selected:
\begin{enumerate}
    \item Both particles touch on their tip side (highest curvature side).
    \item Both particles touch on their flank side (lowest curvature side).
    \item The tip of one particle touches the flank of the other.
\end{enumerate}
...
\begin{figure}
    \begin{subfigure}{\linewidth}
        \centering
        \includegraphics[width=\linewidth]{sim/two_particle/studies/ovality_tip_tip/neck_size}
...
\begin{figure}
    ...
    \begin{subfigure}{\linewidth}
        \centering
        \includegraphics[width=\linewidth]{sim/two_particle/studies/ovality_tip_tip/shrinkage_map}
        \caption{Time Isolines}
...
The oval particles behave here similarly to a particle of smaller size.
...
\begin{figure}
    \begin{subfigure}{\linewidth}
        \centering
        \includegraphics[width=\linewidth]{sim/two_particle/studies/ovality_flank_flank/2.00000/evolution}
        \caption{$\Ovality = \num{2}$}
        \label{fig:two_particle/studies/ovality_flank_flank/2.00000/evolution}
    \end{subfigure}
    \begin{subfigure}{\linewidth}
        \centering
        \includegraphics[width=\linewidth]{sim/two_particle/studies/ovality_flank_flank/3.00000/evolution}
        \caption{$\Ovality = \num{3}$}
        \label{fig:two_particle/studies/ovality_flank_flank/3.00000/evolution}
    \end{subfigure}
    \caption{Geometry Evolutions for Selected Ovalities in Flank-Flank Contacts}
...
\begin{figure}
    \begin{subfigure}{\linewidth}
        \centering
        \includegraphics[width=\linewidth]{sim/two_particle/studies/ovality_flank_flank/neck_size}
        \caption{Evolution Curves}
...
\begin{figure}
    ...
    \end{subfigure}
    \caption{Geometry Evolutions for Selected Ovalities in Tip-Flank Contacts}
...
\begin{figure}
    ...
    \begin{subfigure}{\linewidth}
        \centering
        \includegraphics[width=\linewidth]{sim/two_particle/studies/ovality_tip_flank/neck_size_map}
        \caption{Time Isolines}
...
\begin{figure}
    \begin{subfigure}{\linewidth}
        \centering
        \includegraphics[width=\linewidth]{sim/two_particle/studies/ovality_tip_flank/shrinkage}
        \caption{Evolution Curves}
...
The neck size is limited by the small diameter of the ellipse.
...
Depending on the contact configuration there is only a slight increase or decrease with the ovality.
