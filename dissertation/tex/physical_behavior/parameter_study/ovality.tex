...
The neck sizes heavily decreases with the ovality as the fill volume in increased and the neck growth is limited by the small diameter of the ellipse.
...
The fill volume is decreased by ovality due to the narrow surface profile around the neck.
...
Although the shorter diffusion paths are acting here, too, the initial distance stays constant over the whole parameter range since the effect vanishes in this configuration.
