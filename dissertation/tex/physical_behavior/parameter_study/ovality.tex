\subsection{Ovality $o$}\label{subsec:parameter-study-ovality}
...
\autoref{fig:two_particle/studies/ovality_tip_tip/shrinkage} shows the dependence of the shrinkage on the particle ovality.
The shrinkage slightly increases with the ovality.
There are two counter-acting effects acting here.
First the diffusion paths are shorter due to the small neck.
Second the distance between the particle centers is increased due to the oval shape.

\autoref{fig:two_particle/studies/ovality_tip_tip/neck_size} shows the dependence of the neck size on the particle ovality.
The neck sizes heavily decreases with the ovality as the neck growth is limited by the small diameter of the ellipse.
The oval particle behaves here similarly to a particle of smaller size.

\autoref{fig:two_particle/studies/ovality_tip_tip/evolution} shows two selected evolutions of the contact geometry.
...
\autoref{fig:two_particle/studies/ovality_flank_flank/shrinkage} shows the dependence of the shrinkage on the particle ovality.
The shrinkages shows a slight decrease with the ovality.
The reasoning is contrary to the tip-tip case, as here longer diffusion paths and smaller particle distance are in effect.

\autoref{fig:two_particle/studies/ovality_flank_flank/neck_size} shows the dependence of the neck size on the particle ovality.
Neck size is heavily increasing with ovality, as it is here limited by the large diameter of the ellipse.
The particles behave like larger ones.

\autoref{fig:two_particle/studies/ovality_flank_flank/evolution} shows two selected evolutions of the contact geometry.
...
\autoref{fig:two_particle/studies/ovality_tip_flank/shrinkage} shows the dependence of the shrinkage on the particle ovality.
The shrinkage increases slightly with the ovality similarly to the tip-tip case, but steeper.
Although the shorter diffusion paths are acting here, too, the intial distance stays constant over the whole parameter range since the effect vanishes in this configuration.

\autoref{fig:two_particle/studies/ovality_tip_flank/neck_size} shows the dependence of the neck size on the particle ovality.
...
\autoref{fig:two_particle/studies/ovality_tip_flank/evolution} shows two selected evolutions of the contact geometry.
It is to be observed that the neck may grow larger than the small diameter, since a steep asymmetric surface contour evolves.
