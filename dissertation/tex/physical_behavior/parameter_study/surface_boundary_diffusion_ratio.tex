...
Also, as shrinkage occurs due to boundary diffusion, the volume needed to fill the neck is lowered due to the particles' approaching, which increases the speed of neck growth.
When grain boundary diffusion is faster than surface diffusion, .
