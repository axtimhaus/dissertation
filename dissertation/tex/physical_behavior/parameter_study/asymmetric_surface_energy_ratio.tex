...
\begin{figure}
    \begin{subfigure}{\linewidth}
        \centering
        \includegraphics{sim/two_particle/studies/surface_energy_asymmetric/1.25000/evolution}
    ...
    \begin{subfigure}{\linewidth}
        \centering
        \includegraphics{sim/two_particle/studies/surface_energy_asymmetric/3.00000/evolution}
        \caption{$\InterfaceEnergy_{\Surface2} / \InterfaceEnergy_{\Surface1} = \num{3}$}
...
\begin{figure}
    \begin{subfigure}{\linewidth}
        \centering
        \includegraphics{sim/two_particle/studies/surface_energy_asymmetric/neck_size}
        \caption{Evolution Curves}
        \label{fig:two_particle/studies/surface_energy_asymmetric/neck_size}
    \end{subfigure}
    \begin{subfigure}{\linewidth}
        \centering
        \includegraphics{sim/two_particle/studies/surface_energy_asymmetric/neck_size_map}
...
\begin{figure}
    \begin{subfigure}{\linewidth}
        \centering
        \includegraphics{sim/two_particle/studies/surface_energy_asymmetric/shrinkage}
        \caption{Evolution Curves}
        \label{fig:two_particle/studies/surface_energy_asymmetric/shrinkage}
    \end{subfigure}
    \begin{subfigure}{\linewidth}
        \centering
        \includegraphics{sim/two_particle/studies/surface_energy_asymmetric/shrinkage_map}
        \caption{Time Isolines}
