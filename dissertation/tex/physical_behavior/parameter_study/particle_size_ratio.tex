\subsection{Particle Size Ratio \texorpdfstring{$\Radius_1 / \Radius_2$}{r2/r1}}\label{subsec:parameter-study-particle-size-ratio}
...
\autoref{fig:two_particle/studies/particle_size_ratio/4.00000/evolution} shows in later stages the limitation of the achievable neck size by the size of the smaller particle.
