...
\begin{figure}[p]
    \begin{subfigure}{0.5\linewidth}
        \includegraphics[scale=0.5]{sim/two_particle/studies/particle_size_ratio/2.00000/evolution}
        \caption{$\Radius_2 / \Radius_1 = \num{2}$}
        \label{fig:two_particle/studies/particle_size_ratio/2.00000/evolution}
    \end{subfigure}%
    \begin{subfigure}{0.5\linewidth}
        \includegraphics[scale=0.5]{sim/two_particle/studies/particle_size_ratio/4.00000/evolution}
        \caption{$\Radius_2 / \Radius_1 = \num{4}$}
...
The material parameters are taken equal on both particles with an grain boundary energy of $\InterfaceEnergy_{\GrainBoundary} = \num{0.5}\InterfaceEnergy_{\Surface}$.

\Cref{fig:two_particle/studies/particle_size_ratio/evolution} shows two selected evolutions of the contact geometry.
...
\Cref{fig:two_particle/studies/particle_size_ratio/4.00000/evolution} shows in later stages the limitation of the achievable neck size by the size of the smaller particle.
...
Until ratios of \numrange{2}{3} the neck growth is accelerated, as the gap between the particles is narrowed by the flatter surface of the large particle, thus fewer volume is necessary to grow the neck.
Above, no further acceleration can be observed, as the neck size is strongly limited by the size of the smaller particle.
The same limitation was reported by \textcite{Kumar2016}, whose model does however take volume fluxes cross the boundary into account.
