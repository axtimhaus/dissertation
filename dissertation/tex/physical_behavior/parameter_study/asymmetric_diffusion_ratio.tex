...
\Cref{fig:two_particle/studies/diffusion_asymmetric/neck_size} shows the dependence of the neck size on the asymmetric surface diffusion ratio.
...
\Cref{fig:two_particle/studies/diffusion_asymmetric/shrinkage} shows the dependence of the shrinkage on the asymmetric surface diffusion ratio.
