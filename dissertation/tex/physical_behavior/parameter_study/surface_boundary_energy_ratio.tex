...
\begin{figure}
    \begin{subfigure}{\linewidth}
        \centering
        \includegraphics{sim/two_particle/studies/surface_boundary_energy/0.10000/evolution}
    ...
    \begin{subfigure}{\linewidth}
        \centering
        \includegraphics{sim/two_particle/studies/surface_boundary_energy/0.90000/evolution}
        \caption{$\InterfaceEnergy_{\GrainBoundary} / \InterfaceEnergy_{\Surface} = \num{0.9}$}
...
\begin{figure}
    \begin{subfigure}{\linewidth}
        \centering
        \includegraphics{sim/two_particle/studies/surface_boundary_energy/neck_size}
        \caption{Evolution Curves}
        \label{fig:two_particle/studies/surface_boundary_energy/neck_size}
    \end{subfigure}
    \begin{subfigure}{\linewidth}
        \centering
        \includegraphics{sim/two_particle/studies/surface_boundary_energy/neck_size_map}
...
\begin{figure}
    \begin{subfigure}{\linewidth}
        \centering
        \includegraphics{sim/two_particle/studies/surface_boundary_energy/shrinkage}
        \caption{Evolution Curves}
        \label{fig:two_particle/studies/surface_boundary_energy/shrinkage}
    \end{subfigure}
    \begin{subfigure}{\linewidth}
        \centering
        \includegraphics{sim/two_particle/studies/surface_boundary_energy/shrinkage_map}
        \caption{Time Isolines}
