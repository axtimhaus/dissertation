...
The angles between the surface lines and the radius vector (surface-radius-angles $\SurfaceRadiusAngle_{\Upper}$ and $\SurfaceRadiusAngle_{\Lower}$) are calculated given the node coordinates using the cosine law as in \autoref{eq:surface-radius-angles}.
