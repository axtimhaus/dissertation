...
For sintering behavior analysis and evaluation of numerical error the volume of a particle has to be determined (actually area due to 2D).
This is done by summing over all element triangles as in \cref{eq:particle-volume}, where $\Nodes$ is the set of all nodes the particle consists of.
