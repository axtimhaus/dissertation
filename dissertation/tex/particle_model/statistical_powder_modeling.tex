...
\end{align}
for which \cref{eq:ovality-o} holds.
...
\end{equation}
we obtain, when inserting \cref{eq:ellipse-a-b-by-ovality}, the equation for the shape function of ovality $f_{\Ovality}$ as
\begin{equation}
...
With a relative height of the wave peaks $\WaveHeight_1 \in [0, 1)$, a count of waves $\WaveCount_1 \in [1 \To)$ and a relative phase shift $\WaveShift_1 \in [0, 0.5)$ we define
\begin{equation}
