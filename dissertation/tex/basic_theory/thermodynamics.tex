...
To circumvent this problem, several approaches have been developed, from which the \gls{CIT} (sometimes referred to as \gls{TIP}) and the thermodynamics of \gls[postunset=true]{IVS} shall be discussed here in particular.
