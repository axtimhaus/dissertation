...
\autoref{eq:fick-first} shows Fick's first law as description of the diffusional flux $\Flux$ for the one-dimensional case.
...
The local vacancy concentration $\VacancyConcentration$, however, depends on the thermal equilibrium vacancy concentration $\VacancyConcentration^\Standard$ and the local chemical potential $\ChemicalPotential$ as in \autoref{eq:vacancy-concentration}.
\begin{equation}
...
This leads to the condition that the sum of either two surface energies must be larger than the third, or this triangle does not exist and \autoref{eq:youngs-dihedral} can not be solved.
