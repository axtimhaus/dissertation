...
\begin{description}
	...
	\item[Evaporation/Condensation] Evaporation of atoms to the gas phase and condensation at another point.
	Fast transport through the gas phase, but usually occurs only at very high temperatures, with very volatile substances or due to chemical reactions.
\end{description}
...
Solely surface diffusion does not cause shrinkage.
...
Shrinkage is usually quantified normed initial size $L_0$ with the current size $L$.
...
The driving force for neck formation is the reduction of surface area in interaction with the energy stored in grain boundaries (which is usually much smaller per area unit).
