...
The coordinate system used shall be denoted hereinafter by $\ldots^{|\ldots}$ superscripts where necessary as done in the figure.
The coordinates of one neck node are shown in the figure as $(\Angle^{\Regarding 1}, \Radius^{\Regarding 1})$ and $(\Angle^{\Regarding 2}, \Radius^{\Regarding 2})$.
