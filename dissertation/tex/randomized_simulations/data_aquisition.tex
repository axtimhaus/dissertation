...
For particle size distributions it is common to use a Weibull distribution (\cref{eq:weibull-particle-size}), with the shape parameter $k$, the scale parameter $S$ and the location parameter $L$.
