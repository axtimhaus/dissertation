...
The study will compare four cases: the nominal case, with three circular particles of equal size, and three powders with equal particle size distribution but one assumed to have circular particles,
