...
\begin{subequations}
	\begin{align}
		...
		\frac{\partial \Radius_\Contact}{\partial \Shift_\Normal^{|\Parent}} \Step\Shift_\Normal^{|\Parent}
		+ \frac{\partial \Radius_\Contact}{\partial \Shift_\Normal^{|\Child}} \Step\Shift_\Normal^{|\Child}
		+ \frac{\partial \Radius_\Contact}{\partial \Shift_\Tangential^{|\Parent}} \Step\Shift_\Tangential^{|\Parent}
		+ \frac{\partial \Radius_\Contact}{\partial \Shift_\Tangential^{|\Child}} \Step\Shift_\Tangential^{|\Child}
		+ \frac{\partial \Radius_\Contact}{\partial \Shift_\RotationAngle} \Step\Shift_\RotationAngle \\
		%
		\Step\Angle_\Contact^{|\Parent} & =
		\frac{\partial \Angle_\Contact^{|\Parent}}{\partial \Shift_\Normal^{|\Parent}} \Step\Shift_\Normal^{|\Parent}
		+ \frac{\partial \Angle_\Contact^{|\Parent}}{\partial \Shift_\Normal^{|\Child}} \Step\Shift_\Normal^{|\Child}
		+ \frac{\partial \Angle_\Contact^{|\Parent}}{\partial \Shift_\Tangential^{|\Parent}} \Step\Shift_\Tangential^{|\Parent}
		+ \frac{\partial \Angle_\Contact^{|\Parent}}{\partial \Shift_\Tangential^{|\Child}} \Step\Shift_\Tangential^{|\Child}
...
\begin{equation}
	\Step\Angle_{\Contact}^{|\Parent} = \arcsin \left[ \frac{\sin \eta}{\Radius'_\Contact} \Step\Shift \right]
...
\begin{equation}
	\frac{\partial \Angle_\Contact^{|\Parent}}{\partial \Shift}
	= \lim_{\Step\Shift \rightarrow 0} \frac{\Step\Angle_\Contact^{|\Parent}}{\Step\Shift}
...
\begin{equation}
	\eta_\Normal^{|\Parent} = \PI - \left( \Angle^{|\Parent} - \Angle_\Contact^{|\Parent} \right) + \left( \PI - \SurfaceVectorAngle_\Normal^{|\Parent} - \SurfaceRadiusAngle_\Lower^{|\Parent} \right)
	\label{eq:contact-eta-normal-parent}
\end{equation}

\begin{equation}
	\eta_\Normal^{|\Child} = \PI + \left( \Angle_\Contact^{|\Child} - \Angle^{|\Child} \right) - \left( \PI - \SurfaceVectorAngle_\Normal^{|\Child} - \SurfaceRadiusAngle_\Upper^{|\Child} \right)
...
\begin{equation}
	\eta_\Tangential = \PI - \left( \Angle^{|\Parent} - \Angle_\Contact^{|\Parent} \right) - \left( \PI - \SurfaceVectorAngle_\Tangential^{|\Parent} - \SurfaceRadiusAngle_\Upper^{|\Parent} \right)
	\label{eq:contact-eta-tangential-parent}
\end{equation}

\begin{equation}
	\eta_\Tangential = \PI + \left( \Angle_\Contact^{|\Child} - \Angle^{|\Child} \right) - \left( \PI - \SurfaceVectorAngle_\Tangential^{|\Child} - \SurfaceRadiusAngle_\Upper^{|\Child} \right)
...
\begin{equation}
	\Step\Shift_{\RotationAngle} = 2 \Radius^{|\Child} \sin \frac{\Step\RotationAngle_\Child}{2}
...
\begin{equation}
	\sum^{\Nodes_\Contact} \Radius^{|\Child}
	\left[
		\Step\Shift_\Normal^{|\Parent} \cos \left( \SurfaceRadiusAngle_\Upper^{|\Child} + \frac\pi2 - \SurfaceVectorAngle_{\Normal\Lower}^{|\Parent}\right)
		+ \Step\Shift_\Normal^{|\Child} \cos \left( \SurfaceRadiusAngle_\Upper^{|\Child} + \SurfaceVectorAngle_{\Normal\Upper}^{|\Child} - \frac\pi2 \right)
		+ \Step\Shift_\Tangential^{|\Parent} \cos \left( \SurfaceRadiusAngle_\Lower^{|\Child} - \frac\pi2 - \SurfaceVectorAngle_{\Tangential\Upper}^{|\Parent}\right)
		+ \Step\Shift_\Tangential^{|\Child} \cos \left( \frac\pi2 - \SurfaceRadiusAngle_\Upper^{|\Child} - \SurfaceVectorAngle_{\Tangential\Upper}^{|\Child}\right)
		\right]
	= 0
