...
Interface description is the key problem in microscopic sintering simulation, \autoref{sec:interfaces} deals with that.
...
A concise approach to non-equilibrium thermodynamics is provided by the \gls{TEP}, discussed in \autoref{sec:extremal-priciple}.
