...
Interface description is the key problem in microscopic sintering simulation, \autoref{sec:interfaces} will concentrate on this topic.
Probabilistic approaches can be used in addition to deterministic methods or replace them entirely, as described in \autoref{sec:monte-carlo}.
A concise approach to non-equilibrium thermodynamics is provided by the \gls{TEP}, discussed in \autoref{sec:extremal-principle}.
