...
\begin{align}
    \Left{\Step\Normal\Shift} &= &-\Right{\Step\Normal\Shift} \\
    \Left{\Step\Tangential\Shift} &= &-\Right{\Step\Tangential\Shift}
...
\begin{equation}
    ...
    = \lim_{\Normal{\Step\Shift} \rightarrow 0}
    \frac{\Particle\Radius'-\Particle\Radius}{\Step\Normal\Shift}
...
\begin{equation}
    ...
    = \lim_{\Normal{\Step\Shift} \rightarrow 0}
    \frac{\Step\Particle\Angle}{\Step\Normal\Shift}
    \label{eq:partial-particle-angle-node-normal}
\end{equation}

\begin{equation}
    \frac{\partial \Particle{\Radius}}{\partial \Tangential\Shift}
    = \lim_{\Tangential{\Step\Shift} \rightarrow 0}
    \frac{\Particle\Radius'-\Particle\Radius}{\Step\Tangential\Shift}
...
\begin{equation}
    ...
    = \lim_{\Tangential{\Step\Shift} \rightarrow 0}
    \frac{\Step\Particle\Angle}{\Step\Tangential\Shift}
