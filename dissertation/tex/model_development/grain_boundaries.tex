...
\begin{align}
    \Left{\Step\Shift_\Normal} &= &-\Right{\Step\Shift_\Normal} \\
    \Left{\Step\Shift_\Tangential} &= &-\Right{\Step\Shift_\Tangential}
...
The left particle (index $\Left$) changes its shape by shifting a single regarded node, while the right particle (index $\Right$) is invariant.
...
This is equivalent to a parallel shifting of the radius line to the tip of the shift vector $\Vect\Step\Shift$.
It is obvious from the drawing, that under these conditions, the particles center must perform the same shift as the node, so $\Vect\Step\Shift$ also describes the movement of the particles center.
...
\begin{equation}
    \frac{\partial \Particle{\Radius}}{\partial \Shift_\Normal}
    = \lim_{{\Step\Shift}_\Normal \rightarrow 0}
    \frac{\Particle\Radius'-\Particle\Radius}{\Step\Shift_\Normal}
    \label{eq:partial-particle-radius-node-normal}
\end{equation}

\begin{equation}
    \frac{\partial \Particle{\Angle}}{\partial \Shift_\Normal}
    = \lim_{{\Step\Shift}_\Normal \rightarrow 0}
    \frac{\Step\Particle\Angle}{\Step\Shift_\Normal}
    \label{eq:partial-particle-angle-node-normal}
\end{equation}

\begin{equation}
    \frac{\partial \Particle{\Radius}}{\partial \Shift_\Tangential}
    = \lim_{{\Step\Shift}_\Tangential \rightarrow 0}
    \frac{\Particle\Radius'-\Particle\Radius}{\Step\Shift_\Tangential}
    \label{eq:partial-particle-radius-node-tangential}
\end{equation}

\begin{equation}
    \frac{\partial \Particle{\Angle}}{\partial \Shift_\Tangential}
    = \lim_{{\Step\Shift}_\Tangential \rightarrow 0}
    \frac{\Step\Particle\Angle}{\Step\Shift_\Tangential}
