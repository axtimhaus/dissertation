...
\begin{equation}
    \DissipationFunction = \frac{1}{2} \frac{\GasConstant\Temperature}{\MolarVolume\Standard\VacancyConcentration} \left( \Upper{\DiffusionCoefficient} \Upper\SurfaceDistance \Upper{\Flux}^2 + \Lower{\DiffusionCoefficient} \Lower{\SurfaceDistance} \Lower{\Flux}^2 \right) \TimeStep
