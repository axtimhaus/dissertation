...
\begin{equation}
    \DissipationFunction = \sum^\Nodes \frac{1}{2} \frac{\GasConstant\Temperature}{\MolarVolume{\VacancyConcentration}_\Standard} \left( \frac{\SurfaceDistance_\Upper {\Flux}_\Upper^2}{{\DiffusionCoefficient}_\Upper} + \frac{{\SurfaceDistance}_\Lower {\Flux}_\Lower^2}{{\DiffusionCoefficient}_\Lower}\right) \Step\Time
