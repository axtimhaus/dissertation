...
\begin{equation}
    \DissipationFunction = \frac{1}{2} \frac{\GasConstant\Temperature}{\MolarVolume\Standard\VacancyConcentration} \left( \frac{\Upper\SurfaceDistance \Upper{\Flux}^2}{\Upper{\DiffusionCoefficient}} + \frac{\Lower{\SurfaceDistance} \Lower{\Flux}^2}{\Lower{\DiffusionCoefficient}} \right) \TimeStep
