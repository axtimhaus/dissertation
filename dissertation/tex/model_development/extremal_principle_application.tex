...
\begin{equation}
    \Dissipation = \sum^\Nodes \left[ \frac{\partial \GibbsEnergy}{\partial \Normal\Shift} \Normal\ShiftStep + \frac{\partial \GibbsEnergy}{\partial \Tangential\Shift} \Tangential\ShiftStep \right]
...
\begin{equation}
    \frac{\partial\Volume}{\partial\Normal{\Shift}} \Normal{\ShiftStep} + \frac{\partial\Volume}{\partial\Tangential{\Shift}} \Tangential{\ShiftStep} = \VolumeStep = \left( \Upper{\Flux} + \Lower{\Flux} \right) \TimeStep
