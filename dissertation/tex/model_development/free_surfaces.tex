...
\begin{align}
    \Upper\SurfaceDistance' &= \sqrt{\Upper{\SurfaceDistance}^2 + \Normal{\Step\Shift}^2 - 2 \Upper{\SurfaceDistance} \Normal{\Step\Shift} \cos \SurfaceNormalAngle} \label{eq:surface-distance-shifted-normal-upper}\\
    \Lower\SurfaceDistance' &= \sqrt{\Lower{\SurfaceDistance}^2 + \Normal{\Step\Shift}^2 - 2 \Lower{\SurfaceDistance} \Normal{\Step\Shift} \cos \SurfaceNormalAngle} \label{eq:surface-distance-shifted-normal-lower}
\end{align}
...
A $\SurfaceNormalAngle > \qty{90}{\degree}$ means a convex surface, thus energy gain when inward shifting (negative $\Normal{\Step\Shift}$).
A $\SurfaceNormalAngle < \qty{90}{\degree}$ means a concave surface, thus energy gain when outward shifting (positive $\Normal{\Step\Shift}$).
...
\begin{equation}
    \frac{\partial \GibbsEnergy}{\partial \Normal{\Shift}} = \lim_{\Step\Normal\Shift \rightarrow 0} \frac{\Step\Normal\GibbsEnergy}{\Step\Normal\Shift} = -\left(\Upper{\InterfaceEnergy} + \Lower{\InterfaceEnergy}\right) \cos \SurfaceNormalAngle
...
\begin{align}
    \Upper\SurfaceDistance' &= \sqrt{\Upper{\SurfaceDistance}^2 + \Tangential{\Step\Shift}^2 - 2 \Upper{\SurfaceDistance} \Tangential{\Step\Shift} \cos \SurfaceTangentAngle} \label{eq:surface-distance-shifted-tangential-upper} \\
    \Lower\SurfaceDistance' &= \sqrt{\Lower{\SurfaceDistance}^2 + \Tangential{\Step\Shift}^2 + 2 \Lower{\SurfaceDistance} \Tangential{\Step\Shift} \cos \SurfaceTangentAngle} \label{eq:surface-distance-shifted-tangential-lower}
\end{align}
...
\begin{equation}
    \frac{\partial \GibbsEnergy}{\partial \Tangential{\Shift}} = \lim_{\Step\Tangential\Shift \rightarrow 0} \frac{\Step\Tangential\GibbsEnergy}{\Step\Tangential\Shift} = -\left(\Upper{\InterfaceEnergy} - \Lower{\InterfaceEnergy}\right) \cos \SurfaceTangentAngle
