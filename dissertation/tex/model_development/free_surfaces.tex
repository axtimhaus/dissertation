...
\begin{align}
    \SurfaceDistance_\Upper' &= \sqrt{{\SurfaceDistance}_\Upper^2 + {\Step\Shift}_\Normal^2 - 2 {\SurfaceDistance}_\Upper {\Step\Shift}_\Normal \cos \SurfaceVectorAngle_\Normal} \label{eq:surface-distance-shifted-normal-upper}\\
