...
The picture on tantalum is contradictive, depending on the regarded reference, it diffuses faster, equivalently or slower than alumina, also depending on temperature.
...
\begin{description}
    ...
    \item[Powder Mixture]
        ...
        The model shall be able to regard different mixtures and investigate their bahvior in simulation instead of laboratory.
\end{description}
