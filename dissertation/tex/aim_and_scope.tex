...
\begin{table}
    \captionabove{Material Data of Alumina, Niobium and Tantalum from Literature}
    \label{tab:material-data}
    \begin{subtable}{\linewidth}
        \captionabove{Interface Energies}
    ...
    \begin{subtable}{\linewidth}
        \captionabove{Interface Diffusion Coefficients}
