...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{img/model_development/grain_matrix_overview}
...
The idea is illustrated in \cref{fig:model_development/grain_matrix_overview}.
...
This approach enables a cascading model hierarchy while going down from the largest to the smallest particles while considering the current large fraction as skeleton.
...
\input{tex/multiscale_approach/pore_detection}
\input{tex/multiscale_approach/continuum_model}
