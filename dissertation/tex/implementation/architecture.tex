...
\begin{itemize}
    ...
    \item a solver routine with adjustable subroutines for the diffusion problem as described in \autoref{sec:solution}
    \item remeshing routines as described in \autoref{sec:remeshing-procedures}
...
\end{itemize}
The code is made available to the public on GitHub at:
\begin{center}
    \url{https://github.com/RefraBund/refrasin}
\end{center}
