...
The signum term is required to support negative dissipations, which occur when the system reaches a quasi-stationary state of the surface near the neck in later stages characterized by small fluctuations.
