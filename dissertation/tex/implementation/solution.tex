...
The angle difference is calculated in accordance to the equations in \cref{sec:surface-evolution} with $\Step\Shift = \dot\Shift \Step\Time$ via
\begin{equation}
...
The solution on free surfaces is easily obtained with high precision by first estimating the vacancy concentrations using \cref{eq:vacancy-concentration}, but expressing the chemical potential by the Gibbs energy gradient of \cref{eq:gibbs-partial-surface-normal} as:
\begin{equation}
...
By balancing the fluxes and dividing by the volume gradient, the normal displacement of a node is obtained as:
\begin{equation}
