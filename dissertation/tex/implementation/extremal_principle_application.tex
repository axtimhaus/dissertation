...
To fix the position of a particle contact group in space, one of its particles must be constrained in its position by a constraint like \autoref{eq:fixed-particle-constraints}.
