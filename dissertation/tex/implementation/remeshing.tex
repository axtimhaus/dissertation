...
A second check is applied that the deletion would not lead to too large distance between the remaining nodes.
...
Additionally, it is checked that adjacent nodes are never deleted in the same run.
