...
The main aim of this procedure is lowering the surface node count were possible and increase it were necessary to be able to choose a time step size as large as possible and lower computational effort.
...
So, too fast coarsening and lack of incfluence of the chosen initial discretization width is avoided.
