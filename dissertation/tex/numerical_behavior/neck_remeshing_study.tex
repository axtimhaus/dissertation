...
Targeting numerical efficiency it is desirable to have this parameter as large as possible as the time step decreases as already noticed in \cref{sec:study-step-size}.
...
In this study the parameter will be altered to get an idea of its effects.
...
The second is the parameterization of the neck remeshing procedure (\cref{sec:neck-neighborhood-remeshing}).
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{sim/two_particle/studies/neck_remeshing/step_count}
    \caption{Step Counts and Simulation Time Consumption in Dependence on the Neck Remeshing Limit}
    \label{fig:two_particle/studies/neck_remeshing/step_count}
\end{figure}
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{sim/two_particle/studies/neck_remeshing/shrinkage}
    \caption{Shrinkage in Dependence on the Neck Remeshing Limit}
    \label{fig:two_particle/studies/neck_remeshing/shrinkage}
\end{figure}
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{sim/two_particle/studies/neck_remeshing/volume_loss}
    \caption{Volume Loss in Dependence on the Neck Remeshing Limit}
    \label{fig:two_particle/studies/neck_remeshing/volume_loss}
\end{figure}
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{sim/two_particle/studies/neck_remeshing/time_step_width}
    \caption{Time Step Width in Dependence on the Neck Remeshing Limit}
    \label{fig:two_particle/studies/neck_remeshing/time_step_width}
\end{figure}

\Cref{fig:two_particle/studies/neck_remeshing/step_count} shows the count of calculated time steps alongside with the total time consumption for the simulations.
...
\Cref{fig:two_particle/studies/neck_remeshing/shrinkage} shows the shrinkage curves obtained from the parameter variation.
...
This can be explained by disregarding of local geometrical features near the neck when using coarse discretization.
...
\Cref{fig:two_particle/studies/neck_remeshing/time_step_width} shows the evolution of the time step width used in the simulations for the distinct cases.
...
If the regard is only paid on late stages, low node counts lead to equivalent results.
