...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{sim/two_particle/studies/time_step/step_count}
    \caption{Step Counts and Simulation Time Consumption in Dependence on the Maximum Displacement Angle}
    \label{fig:two_particle/studies/time_step/step_count}
\end{figure}
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{sim/two_particle/studies/time_step/shrinkage}
    \caption{Shrinkage in Dependence on the Maximum Displacement Angle}
    \label{fig:two_particle/studies/time_step/shrinkage}
\end{figure}
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{sim/two_particle/studies/time_step/volume_loss}
    \caption{Volume Loss in Dependence on the Maximum Displacement Angle}
    \label{fig:two_particle/studies/time_step/volume_loss}
\end{figure}
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{sim/two_particle/studies/time_step/time_step_width}
    \caption{Time Step Width in Dependence on the Maximum Displacement Angle}
...
For lower values the time step width follows the general trend that after neck remeshing has deleted a surface node, the step jumps up and then decreases quite continuously till the next remeshing as the neck node approaches the next surface node.
...
With regard to the high memory usage for result data storing the maximum displacement angle \qty{0.005}{\radian} is chosen for the followings investigation as it provides the best trade-off.
Lower values did not provide notable better performance in the test case but produce significantly higher amounts of data.
