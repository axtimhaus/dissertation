...
In \autoref{subsec:time-integration-scheme} the limit of the time step width to use during time integration was given.
...
\autoref{fig:two_particle/studies/time_step/volume_loss} shows the loss of volume in the system during simulation in dependence on the time step parameter.
...
Especially for \qty{0.05}{\rad} and above the error escalates in the later stages.
...
This issue will be addressed in detail in \autoref{sec:study-neck-remeshing}.
