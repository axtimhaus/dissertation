\section{Study on the Influence of the Time Step Size}
...
During testing, circular shaped particles have been found to be more prone to instabilities on their surface than irregular ones due to their smooth surface profile.
The maximum displacement angle is varied between \qtyrange{0.001}{0.1}{\radian}.
Surface remeshing is deactivated to keep the finely discretized surface.

Targets of investigation are the time consumption (duration) of the differently parametrized simulations and the step count needed.
As measure for precision their agreement in shrinkage and the overall volume loss are regarded.

\subsection{Discussion of the Results}

\begin{figure}
    \includegraphics{sim/time_step_study/plots/step_count}
    \caption{Step Counts and Simulation Time Consumption Used in Dependence on the Maximum Displacement Angle}
    \label{fig:time_step_study/plots/step_count}
\end{figure}

\autoref{fig:time_step_study/plots/step_count} shows the count of calculated time steps alongside with the total time consumption for the simulations.
...
\begin{figure}
    \includegraphics{sim/time_step_study/plots/shrinkage}
    \caption{Shrinkage Result Curves Obtained from the Simulations in Dependence on the Maximum Displacement Angle}
    \label{fig:time_step_study/plots/shrinkage}
\end{figure}

\autoref{fig:time_step_study/plots/shrinkage} shows the shrinkage curves obtained from the parameter variation.
...
\begin{figure}
    \includegraphics{sim/time_step_study/plots/volume_loss}
    \caption{Volume Loss During Simulation in Dependence on the Maximum Displacement Angle}
    \label{fig:time_step_study/plots/volume_loss}
\end{figure}

\autoref{fig:time_step_study/plots/volume_loss} shows the loss of volume for both particles (solid and dashed lines) in the simulations with the varied parameter (color).
