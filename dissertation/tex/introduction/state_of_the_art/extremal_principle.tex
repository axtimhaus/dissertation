...
\begin{subequations}
    \begin{align}
        ...
        &&\stackrel{!}{=} 0 \\
        %
        &\vect{\LagrangeFunction_{\AuxiliaryVariable}} &&=
        ...
        %
        &\vect{\LagrangeFunction_{\LagrangeParameter_2}} &&= \vect\RequiredConstraint(\vect\ExternalStateVariable, \vect\InternalStateVariable, \vect{\InternalStateVelocity}, \vect\Flux, \vect\AuxiliaryVariable) &&\stackrel{!}{=} 0 \\
        %
        &\vect{\LagrangeFunction_{\LagrangeParameter_3}} &&= \vect\AddionalConstraint(\vect\ExternalStateVariable, \vect\InternalStateVariable, \vect{\InternalStateVelocity}, \vect\Flux, \vect\AuxiliaryVariable) &&\stackrel{!}{=} 0
    \end{align}
\end{subequations}
